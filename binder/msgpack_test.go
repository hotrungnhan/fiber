...
type MsgpackBinding struct {
	MsgPackDecoder func([]byte, interface{}) error
}

func (b *MsgpackBinding) Name() string {
	return "msgpack"
}

func (b *MsgpackBinding) Bind(data []byte, v interface{}) error {
	return b.MsgPackDecoder(data, v)
}
